// Stub for expo-router/node/render.js
//
// Expo SDK 54 Metro always invokes the expo-router SSR pipeline during
// `expo export --platform web`, even for apps that don't use expo-router.
// This stub satisfies the module requirement by returning a complete HTML
// shell. Client-side React Navigation handles all routing.
...
module.exports.default = { renderAsync };
